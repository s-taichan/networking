...
public class ChatPanel {
	...
	JButton chatHundleButton = new JButton("送信");
	...
	public ChatPanel(String title) {
		...
		// チェット送信
/*		JPanel chatSubmitPanel1 = new JPanel();
		chatSubmitPanel1.setLayout(new GridLayout(1, 1));
		chatSubmitPanel1.add(new JLabel("つぶやく"));
*/
